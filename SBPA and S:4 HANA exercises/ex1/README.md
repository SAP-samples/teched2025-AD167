...
1.	Logon to the S/4HANA system
   S/4HANA Cloud URL: https://my427029.s4hana.cloud.sap/ui
  	Username / Password: Login with your user id AD167-XXX@education.cloud.sap where XXX is your assigned user like 001 or 002 and so on and the password will be TechEd25onTour!
...
5.	Sales Order record will be opened. Type **“ref”** in the **Cust. Reference** field and click on **"Save"**.
...
6. The sales Order Number is displayed at the bottom.  **Important** Please, note down the Sales Order number. We will use this later while designing and executing the end-to-end process..
   ![alt text](https://github.com/SAP-samples/teched2025-AD167/blob/main/SBPA%20and%20S%3A4%20HANA%20exercises/ex1/images/SalesOrderCreated.png)
